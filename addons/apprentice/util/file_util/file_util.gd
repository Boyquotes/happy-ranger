...
static func read_as_csv(file_path: String, delim: String = ",") -> Array[PackedStringArray]:
	...
	if reader:
		var line : PackedStringArray = reader.get_csv_line(",")
...
static func read_as_text(file_path: String, skip_cr: bool = false) -> String:
...
## 获取全局文件路径
static func get_global_path(path: String) -> String:
